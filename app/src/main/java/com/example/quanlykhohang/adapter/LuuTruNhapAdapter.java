...
public class LuuTruNhapAdapter extends RecyclerView.Adapter<LuuTruNhapAdapter.viewholder>{
    ...
    public LuuTruNhapAdapter(Context context, ArrayList<Bill> list) {
    ...
    @NonNull
    @Override
    public LuuTruNhapAdapter.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LuuTruNhapAdapter.viewholder holder, int position) {
        ...
        if(dk!=1){
            userDao.updateLastAction(user,"xem hóa đơn nhập lưu trữ");
        }
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        userDao.updateLastAction(user,"hủy lưu trữ hóa đơn nhập");
                        dk=1;
